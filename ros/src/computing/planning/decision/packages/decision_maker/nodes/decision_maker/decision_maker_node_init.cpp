...
void DecisionMakerNode::createPublisher(void)
{
  ...
  Pubs["state_vehicle"] = private_nh_.advertise<std_msgs::String>("state/vehicle", 1, true);
  Pubs["state_mission"] = private_nh_.advertise<std_msgs::String>("state/mission", 1, true);
  Pubs["state_drive"] = private_nh_.advertise<std_msgs::String>("state/drive", 1, true);
